...
export default function ProjectPopup() {
  ...
  return (
    <motion.div
      ...
      className="fixed top-25 left-70 p-4 md:p-6 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-700 dark:bg-zinc-900 h-120 w-[120vw] md:w-[70vw] backdrop-blur-2xl"
    >
