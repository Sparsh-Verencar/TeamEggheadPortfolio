...
export default function AboutTeam() {
  ...
  return (
    <motion.div
      ...
      className="fixed top-10 left-60 z-50 p-4 md:p-6 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-700 dark:bg-zinc-900 overflow-hidden bg-transparent h-150 scale-90 sm:scale-75"
    >
